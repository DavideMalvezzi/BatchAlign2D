...
set id 4
set name batch_align2D_region_fadd_32ns_32ns_32_7_full_dsp_1
...
set id 20
set name batch_align2D_region_mux_646_32_1_1
...
set id 36
set name batch_align2D_region_mux_94_32_1_1
set corename simcore_mux
set op mux
set stage_num 1
set max_latency -1
...
set ID 55
set hasByteEnable 0
set MemName gauss_newton_optim_r_mask_table1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 56 \
    name pyr_region_data \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename pyr_region_data \
    op interface \
    ports { pyr_region_data_address0 { O 12 vector } pyr_region_data_ce0 { O 1 bit } pyr_region_data_q0 { I 8 vector } pyr_region_data_address1 { O 12 vector } pyr_region_data_ce1 { O 1 bit } pyr_region_data_q1 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pyr_region_data'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 196 \
    name ref_patch_with_border \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename ref_patch_with_border \
    op interface \
    ports { ref_patch_with_border_address0 { O 7 vector } ref_patch_with_border_ce0 { O 1 bit } ref_patch_with_border_q0 { I 8 vector } ref_patch_with_border_address1 { O 7 vector } ref_patch_with_border_ce1 { O 1 bit } ref_patch_with_border_q1 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'ref_patch_with_border'"
}
}
...
eval "cg_default_interface_gen_dc { \
    id 197 \
    name cur_px_estimate_0_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_cur_px_estimate_0_read \
    op interface \
    ports { cur_px_estimate_0_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 198 \
    name cur_px_estimate_1_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_cur_px_estimate_1_read \
    op interface \
    ports { cur_px_estimate_1_read { I 32 vector } } \
} "
}

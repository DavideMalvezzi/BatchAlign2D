...
entity gauss_newton_optim_r_mask_table1_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of gauss_newton_optim_r_mask_table1_rom is 
...
entity gauss_newton_optim_r_mask_table1 is
    generic (
...
architecture arch of gauss_newton_optim_r_mask_table1 is
    component gauss_newton_optim_r_mask_table1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    gauss_newton_optim_r_mask_table1_rom_U :  component gauss_newton_optim_r_mask_table1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

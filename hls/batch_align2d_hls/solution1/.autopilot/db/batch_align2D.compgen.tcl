...
set id 1
set name batch_align2D_faddfsub_32ns_32ns_32_4_full_dsp_1
...
set id 3
set name batch_align2D_fsub_32ns_32ns_32_4_full_dsp_1
...
set id 5
set name batch_align2D_fmul_32ns_32ns_32_2_max_dsp_1
...
set id 11
set name batch_align2D_fdiv_32ns_32ns_32_8_1
...
set id 17
set name batch_align2D_sitofp_32s_32_3_1
...
set id 18
set name batch_align2D_mux_1287_8_1_1
...
set id 20
set name batch_align2D_mux_1007_8_1_1
set corename simcore_mux
set op mux
set stage_num 1
set max_latency -1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler batch_align2D_ctrl_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler batch_align2D_param_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 8.75 \ 
    is_flushable 0 \ 
    name {batch_align2D_pyr_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'pyr'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler batch_align2D_pyr_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 8.75 \ 
    is_flushable 0 \ 
    name {batch_align2D_pos_r_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'pos_r'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler batch_align2D_pos_r_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 8.75 \ 
    is_flushable 0 \ 
    name {batch_align2D_debug_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'debug'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler batch_align2D_debug_m_axi
}

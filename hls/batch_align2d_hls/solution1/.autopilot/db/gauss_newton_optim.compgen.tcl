...
set id 138
set name batch_align2D_fptrunc_64ns_32_1_1
...
set id 141
set name batch_align2D_fpext_32ns_64_1_1
...
set id 143
set name batch_align2D_dsub_64ns_64ns_64_5_full_dsp_1
...
set id 145
set name batch_align2D_dmul_64ns_64ns_64_5_max_dsp_1
...
set id 153
set name batch_align2D_mux_646_32_1_1
...
set id 154
set name batch_align2D_mux_94_32_1_1
set corename simcore_mux
set op mux
set stage_num 1
set max_latency -1
...
set id 155
set name batch_align2D_mux_32_32_1_1
set corename simcore_mux
set op mux
set stage_num 1
set max_latency -1
...
set id 156
set name batch_align2D_ama_addmuladd_7ns_3s_7s_7ns_7_1_1
...
set out_width 7
set exp (i0+i1)*i2+i3
set arg_lists {i0 {7 0 +} i1 {3 1 +} s {7 1 +} i2 {7 1 +} m {7 1 +} i3 {7 0 +} p {7 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 166
set hasByteEnable 0
set MemName gauss_newton_optim_mask_table2
...
eval "cg_default_interface_gen_dc { \
    id 341 \
    name cur_px_estimate_0_r \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_cur_px_estimate_0_r \
    op interface \
    ports { cur_px_estimate_0_r { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 342 \
    name cur_px_estimate_1_r \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_cur_px_estimate_1_r \
    op interface \
    ports { cur_px_estimate_1_r { I 32 vector } } \
} "
}

...
## Variables
set Top "batch_align2D_region"
set TopNoPrefix "batch_align2D_region"
...
set Interfaces {
    s_axi_ctrl {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 myRegion_data_ptr W 0x0 "Data signal of myRegion_data_ptr" {{0 32 myRegion_data_ptr W 0 "Bit 31 to 0 Data signal of myRegion_data_ptr"}}} {0x18 myRegion_fcoord_ptr W 0x0 "Data signal of myRegion_fcoord_ptr" {{0 32 myRegion_fcoord_ptr W 0 "Bit 31 to 0 Data signal of myRegion_fcoord_ptr"}}} {0x20 my_ref_patch_with_border_ptr W 0x0 "Data signal of my_ref_patch_with_border_ptr" {{0 32 my_ref_patch_with_border_ptr W 0 "Bit 31 to 0 Data signal of my_ref_patch_with_border_ptr"}}} {0x28 my_cur_px_estimate_ptr W 0x0 "Data signal of my_cur_px_estimate_ptr" {{0 32 my_cur_px_estimate_ptr W 0 "Bit 31 to 0 Data signal of my_cur_px_estimate_ptr"}}} {0x30 my_inv_out W 0x0 "Data signal of my_inv_out" {{0 32 my_inv_out W 0 "Bit 31 to 0 Data signal of my_inv_out"}}} {0x38 my_debug_array_ptr W 0x0 "Data signal of my_debug_array_ptr" {{0 32 my_debug_array_ptr W 0 "Bit 31 to 0 Data signal of my_debug_array_ptr"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    s_axi_param {
        ...
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 my_converged_1 R 0x0 "Data signal of my_converged" {{0 32 my_converged R 0 "Bit 31 to 0 Data signal of my_converged"}}} {0x14 my_converged_2 R 0x0 "Data signal of my_converged" {{0 32 my_converged R 0 "Bit 63 to 32 Data signal of my_converged"}}} {0x18 my_converged_ctrl R 0x0 "Control signal of my_converged" {{0 1 my_converged_ap_vld R 0 "Control signal my_converged_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c n_iter W 0x0 "Data signal of n_iter" {{0 32 n_iter W 0 "Bit 31 to 0 Data signal of n_iter"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl s_axi_param m_axi_my_region_data m_axi_my_region_fcoord m_axi_my_patches m_axi_my_pos m_axi_my_debug m_axi_my_debug_array"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_my_region_data {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_my_region_data"
        data_width "32"
        param_prefix "C_M_AXI_MY_REGION_DATA"
    ...
    m_axi_my_region_fcoord {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_my_region_fcoord"
        data_width "32"
        param_prefix "C_M_AXI_MY_REGION_FCOORD"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_my_patches {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_my_patches"
        data_width "32"
        param_prefix "C_M_AXI_MY_PATCHES"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_my_pos {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_my_pos"
        data_width "32"
        param_prefix "C_M_AXI_MY_POS"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_my_debug {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_my_debug"
        data_width "32"
        param_prefix "C_M_AXI_MY_DEBUG"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_my_debug_array {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_my_debug_array"
        data_width "32"
        param_prefix "C_M_AXI_MY_DEBUG_ARRAY"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 41660 II x}

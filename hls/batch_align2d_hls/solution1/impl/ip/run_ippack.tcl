...
## Variables
set Top "batch_align2D"
set TopNoPrefix "batch_align2D"
...
set Interfaces {
    s_axi_ctrl {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 pyr_data_ptr_1 W 0x0 "Data signal of pyr_data_ptr" {{0 32 pyr_data_ptr W 0 "Bit 31 to 0 Data signal of pyr_data_ptr"}}} {0x14 pyr_data_ptr_2 W 0x0 "Data signal of pyr_data_ptr" {{0 32 pyr_data_ptr W 0 "Bit 63 to 32 Data signal of pyr_data_ptr"}}} {0x1c ref_patch_with_border_ptr_1 W 0x0 "Data signal of ref_patch_with_border_ptr" {{0 32 ref_patch_with_border_ptr W 0 "Bit 31 to 0 Data signal of ref_patch_with_border_ptr"}}} {0x20 ref_patch_with_border_ptr_2 W 0x0 "Data signal of ref_patch_with_border_ptr" {{0 32 ref_patch_with_border_ptr W 0 "Bit 63 to 32 Data signal of ref_patch_with_border_ptr"}}} {0x28 cur_px_estimate_ptr_1 W 0x0 "Data signal of cur_px_estimate_ptr" {{0 32 cur_px_estimate_ptr W 0 "Bit 31 to 0 Data signal of cur_px_estimate_ptr"}}} {0x2c cur_px_estimate_ptr_2 W 0x0 "Data signal of cur_px_estimate_ptr" {{0 32 cur_px_estimate_ptr W 0 "Bit 63 to 32 Data signal of cur_px_estimate_ptr"}}} {0x34 inv_out_1 W 0x0 "Data signal of inv_out" {{0 32 inv_out W 0 "Bit 31 to 0 Data signal of inv_out"}}} {0x38 inv_out_2 W 0x0 "Data signal of inv_out" {{0 32 inv_out W 0 "Bit 63 to 32 Data signal of inv_out"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    s_axi_param {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_param"
        param_prefix "C_S_AXI_PARAM"
        addr_bits "7"
        port_width "AWADDR 7 WDATA 32 WSTRB 4 ARADDR 7 RDATA 32"
        registers {{0x10 img_w W 0x0 "Data signal of img_w" {{0 16 img_w W 0 "Bit 15 to 0 Data signal of img_w"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 img_h W 0x0 "Data signal of img_h" {{0 16 img_h W 0 "Bit 15 to 0 Data signal of img_h"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 levels_1 W 0x0 "Data signal of levels" {{0 32 levels W 0 "Bit 31 to 0 Data signal of levels"}}} {0x24 levels_2 W 0x0 "Data signal of levels" {{0 32 levels W 0 "Bit 63 to 32 Data signal of levels"}}} {0x28 levels_3 W 0x0 "Data signal of levels" {{0 32 levels W 0 "Bit 95 to 64 Data signal of levels"}}} {0x2c levels_4 W 0x0 "Data signal of levels" {{0 32 levels W 0 "Bit 127 to 96 Data signal of levels"}}} {0x34 converged_1 R 0x0 "Data signal of converged" {{0 32 converged R 0 "Bit 31 to 0 Data signal of converged"}}} {0x38 converged_2 R 0x0 "Data signal of converged" {{0 32 converged R 0 "Bit 63 to 32 Data signal of converged"}}} {0x3c converged_ctrl R 0x0 "Control signal of converged" {{0 1 converged_ap_vld R 0 "Control signal converged_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 n_iter W 0x0 "Data signal of n_iter" {{0 32 n_iter W 0 "Bit 31 to 0 Data signal of n_iter"}}} {0x48 transfer_pyr W 0x0 "Data signal of transfer_pyr" {{0 1 transfer_pyr W 0 "Bit 0 to 0 Data signal of transfer_pyr"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl s_axi_param m_axi_pyr m_axi_patches m_axi_pos_r m_axi_debug"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_pyr {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_pyr"
        data_width "32"
        param_prefix "C_M_AXI_PYR"
    ...
    m_axi_patches {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_patches"
        data_width "32"
        param_prefix "C_M_AXI_PATCHES"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_pos_r {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_pos_r"
        data_width "32"
        param_prefix "C_M_AXI_POS_R"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_debug {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_debug"
        data_width "32"
        param_prefix "C_M_AXI_DEBUG"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 1713 II x}

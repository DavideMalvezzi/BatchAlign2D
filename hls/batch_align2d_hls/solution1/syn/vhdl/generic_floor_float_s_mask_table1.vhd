...
entity generic_floor_float_s_mask_table1_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of generic_floor_float_s_mask_table1_rom is 
...
entity generic_floor_float_s_mask_table1 is
    generic (
...
architecture arch of generic_floor_float_s_mask_table1 is
    component generic_floor_float_s_mask_table1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    generic_floor_float_s_mask_table1_rom_U :  component generic_floor_float_s_mask_table1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

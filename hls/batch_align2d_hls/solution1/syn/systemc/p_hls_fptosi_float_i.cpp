...
p_hls_fptosi_float_i::p_hls_fptosi_float_i(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_mantissa_V_2_cast2_fu_80_p1);
    sensitive << ( mantissa_V_fu_70_p4 );

    SC_METHOD(thread_mantissa_V_fu_70_p4);
    sensitive << ( tmp_V_38_fu_66_p1 );
    ...
    sensitive << ( mantissa_V_fu_70_p4 );
    sensitive << ( sh_assign_4_cast_cas_fu_124_p1 );

    SC_METHOD(thread_result_V_1_fu_174_p2);
    sensitive << ( p_Val2_31_fu_166_p3 );

    SC_METHOD(thread_sh_assign_4_cast_cas_fu_124_p1);
    sensitive << ( ush_fu_112_p3 );

    SC_METHOD(thread_sh_assign_4_cast_fu_120_p1);
    sensitive << ( ush_fu_112_p3 );
    ...
    sc_trace(mVcdFile, tmp_V_38_fu_66_p1, "tmp_V_38_fu_66_p1");
...
void p_hls_fptosi_float_i::thread_ap_return() {
    ap_return = (!p_Result_s_fu_48_p3.read()[0].is_01())? sc_lv<32>(): ((p_Result_s_fu_48_p3.read()[0].to_bool())? result_V_1_fu_174_p2.read(): p_Val2_31_fu_166_p3.read());
}
...
void p_hls_fptosi_float_i::thread_mantissa_V_2_cast2_fu_80_p1() {
    mantissa_V_2_cast2_fu_80_p1 = esl_zext<79,25>(mantissa_V_fu_70_p4.read());
}

void p_hls_fptosi_float_i::thread_mantissa_V_fu_70_p4() {
    mantissa_V_fu_70_p4 = esl_concat<24,1>(esl_concat<1,23>(ap_const_lv1_1, tmp_V_38_fu_66_p1.read()), ap_const_lv1_0);
}
...
void p_hls_fptosi_float_i::thread_r_V_fu_132_p2() {
    r_V_fu_132_p2 = (!sh_assign_4_cast_cas_fu_124_p1.read().is_01())? sc_lv<25>(): mantissa_V_fu_70_p4.read() >> (unsigned short)sh_assign_4_cast_cas_fu_124_p1.read().to_uint();
}

void p_hls_fptosi_float_i::thread_result_V_1_fu_174_p2() {
    result_V_1_fu_174_p2 = (!ap_const_lv32_0.is_01() || !p_Val2_31_fu_166_p3.read().is_01())? sc_lv<32>(): (sc_biguint<32>(ap_const_lv32_0) - sc_biguint<32>(p_Val2_31_fu_166_p3.read()));
}

void p_hls_fptosi_float_i::thread_sh_assign_4_cast_cas_fu_124_p1() {
    sh_assign_4_cast_cas_fu_124_p1 = esl_sext<25,9>(ush_fu_112_p3.read());
}

void p_hls_fptosi_float_i::thread_sh_assign_4_cast_fu_120_p1() {
    sh_assign_4_cast_fu_120_p1 = esl_sext<32,9>(ush_fu_112_p3.read());
}
...
void p_hls_fptosi_float_i::thread_tmp_V_38_fu_66_p1() {
    tmp_V_38_fu_66_p1 = p_Val2_s_fu_44_p1.read().range(23-1, 0);
}
...
void p_hls_fptosi_float_i::thread_tmp_i_i_i_cast1_fu_84_p1() {
    tmp_i_i_i_cast1_fu_84_p1 = esl_zext<9,8>(tmp_V_fu_56_p4.read());
}

void p_hls_fptosi_float_i::thread_tmp_s_fu_152_p1() {

...
// ==============================================================
#ifndef __gauss_newton_optim_mask_table2_H__
#define __gauss_newton_optim_mask_table2_H__
...
struct gauss_newton_optim_mask_table2_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(gauss_newton_optim_mask_table2_ram) {
...
SC_MODULE(gauss_newton_optim_mask_table2) {
...
gauss_newton_optim_mask_table2_ram* meminst;


SC_CTOR(gauss_newton_optim_mask_table2) {
meminst = new gauss_newton_optim_mask_table2_ram("gauss_newton_optim_mask_table2_ram");

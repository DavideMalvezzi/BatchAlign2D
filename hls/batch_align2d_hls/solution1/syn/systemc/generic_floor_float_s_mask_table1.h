...
// ==============================================================
#ifndef __generic_floor_float_s_mask_table1_H__
#define __generic_floor_float_s_mask_table1_H__
...
struct generic_floor_float_s_mask_table1_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(generic_floor_float_s_mask_table1_ram) {
...
SC_MODULE(generic_floor_float_s_mask_table1) {
...
generic_floor_float_s_mask_table1_ram* meminst;


SC_CTOR(generic_floor_float_s_mask_table1) {
meminst = new generic_floor_float_s_mask_table1_ram("generic_floor_float_s_mask_table1_ram");
